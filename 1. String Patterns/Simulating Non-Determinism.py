...
# fill in your code here 
    if string == '':
        ...
        # if len(string) == 1 and ((current, string[0]) in edges):
        #     dest_list = edges[(current, string[0])]
        #     if len(dest_list) == 1: #cheating, since I know acceping states will be in lists of length one...
        #         return True
        #     else:
        #         return False        
        ...
        #             return nfsmsim(string[1:], dest, edges, accepting) 
        #     return False
        ...
        if (current, letter) in edges:
            ...
            for newstate in newstates:
                if nfsmsim(remainder, newstate, edges, accepting):
                    return True # yo, this is way, way more elegant that what I banged out
        return False        
